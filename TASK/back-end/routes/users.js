...
router.delete('/deleteTask/:taskId', async(req, res) => {
  ...
  res.json({ // Send a JSON response back to the client.
    ...
    deletedTaskId: removedTask.id /* The ID of the deleted task. The value is retrieved from the removed task object, 
    which is the task which is deleted from the database*/
  })
} 
  catch (error) {
